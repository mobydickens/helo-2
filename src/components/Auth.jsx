        ...
        <div className='container mx-auto w-2/5 h-screen flex flex-col justify-center'>
          <div className='w-full h-500px bg-gradient flex flex-col items-center justify-center shadow-lg'>
            ...
            <div>
              ...
              <button className='bg-grey-darkest hover:bg-pink hover:border-pink text-white font-semibold py-2 px-4 border border-grey-darkest shadow m-5'>Register</button>
            </div>
          </div>
        </div>
      </div>
